...
> Ключевые достижения go-code — измеренные эмпирически на krolik (ARM 24GB, Oracle Cloud, San Jose CA).
...
**Развёрнут:** `http://mcp.krolik.run/code/mcp` (krolik ARM, порт 8897)  
...
|---|---|---|---|
| PostgreSQL + AGE | ✅ | krolik-postgres-age:17, AGE 1.7.0 | custom ARM Docker image |
...
| На твоём железе | ✅ ARM krolik | ❌ SaaS | ❌ SaaS | ❌ SaaS | ✅ |
