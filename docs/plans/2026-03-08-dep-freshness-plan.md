...
Run: `cd /home/krolik/src/go-code && go test ./internal/freshness/ -v -run TestDependency`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/freshness/ -v`
Expected: PASS
...
Run: `cd /home/krolik/src/go-code && go test ./internal/freshness/ -v -run TestParseGoMod`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/freshness/ -v -run TestParsePackageJSON`
...
4. Verify via MCP: `code_health repo=/home/krolik/src/go-code`
