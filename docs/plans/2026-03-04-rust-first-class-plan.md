...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -v -count=1 2>&1 | tail -5`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -run TestParseRust -v -count=1`
Expected: PASS
...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -run TestRustCallExtraction -v -count=1`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -run TestRustRelationships -v -count=1`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -run TestRustVisibilityAndAttributes -v -count=1`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/deadcode/ -run "TestAnalyze_Rust" -v -count=1`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/deadcode/ -v -count=1 2>&1 | tail -10`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/analyze/ -v -count=1 2>&1 | tail -10`
Expected: all PASS
...
Run: `cd /home/krolik/src/go-code && go test ./internal/polyglot/ -run TestParseCargo -v -count=1`
...
```bash
cd /home/krolik/src/go-code && make test
```
