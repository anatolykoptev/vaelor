...
**Files:**
- Create: `/path/to/repos/src/go-code/internal/compare/grade.go`
- Create: `/path/to/repos/src/go-code/internal/compare/grade_test.go`
- Modify: `/path/to/repos/src/go-code/internal/compare/compare.go:108-120` (RepoMetrics → add Grade field)
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run TestComputeGrade -v`
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run TestGradeScore_Range -v`
Expected: PASS

**Step 5: Add Grade field to RepoMetrics**

In `/path/to/repos/src/go-code/internal/compare/compare.go`, add to `RepoMetrics`:
...
In `/path/to/repos/src/go-code/internal/compare/metrics.go`, add at end of `ComputeMetrics` before `return`:
...
**Files:**
- Create: `/path/to/repos/src/go-code/internal/compare/importdiff.go`
- Create: `/path/to/repos/src/go-code/internal/compare/importdiff_test.go`
- Modify: `/path/to/repos/src/go-code/internal/compare/compare.go:164-176` (CompareResult → add ImportDiff)
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run TestComputeImportDiff -v`
...
In `/path/to/repos/src/go-code/internal/compare/compare.go`, add `ImportDiff` field to `CompareResult`:
...
**Files:**
- Create: `/path/to/repos/src/go-code/internal/compare/churn.go`
- Create: `/path/to/repos/src/go-code/internal/compare/churn_test.go`
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run TestParseNumstatLine -v`
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run TestCollectChurn_RealRepo -v`
Expected: PASS
...
**Files:**
- Create: `/path/to/repos/src/go-code/internal/compare/hotspot.go`
- Create: `/path/to/repos/src/go-code/internal/compare/hotspot_test.go`
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run TestComputeHotspots -v`
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run "TestComputeHotspots|TestPercentileRank" -v`
Expected: All PASS
...
**Files:**
- Modify: `/path/to/repos/src/go-code/internal/compare/compare.go:164-274` (add hotspot fields + collection)
- Modify: `/path/to/repos/src/go-code/internal/compare/context.go` (add hotspot section)
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run TestBuildCompareContext_IncludesHotspots -v`
Expected: FAIL — `BuildCompareContextV2` undefined

**Step 3: Update BuildCompareContext to accept hotspots**

In `/path/to/repos/src/go-code/internal/compare/context.go`:
