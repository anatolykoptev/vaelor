...
Run: `cd /path/to/repos/src/go-code && go test ./internal/embeddings/ -run TestSimilarPair -v`
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/semhealth/ -v`
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/compare/ -run "TestSemanticDup" -v`
...
Run: `cd /path/to/repos/src/go-code && go test ./cmd/go-code/ -run TestCodeHealthXML -v`
Expected: PASS
...
Run: `cd /path/to/repos/src/go-code && go test ./cmd/go-code/ -run TestSemanticDup -v`
Expected: PASS
...
```bash
cd /path/to/repos/src/go-code && make build
```
