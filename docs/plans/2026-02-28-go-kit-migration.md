...
**go-code** is at `/path/to/repos/src/go-code/` — a code intelligence MCP server.

**go-kit** is at `/path/to/repos/src/go-kit/` — shared infrastructure module (`github.com/anatolykoptev/go-kit` v0.1.0) with packages: env, llm, retry, metrics, strutil, cache.
