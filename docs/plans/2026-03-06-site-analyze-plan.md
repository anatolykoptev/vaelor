...
**Files:**
- Create: `/home/krolik/src/ox-browser/crates/security/src/fingerprint.rs`
- Modify: `/home/krolik/src/ox-browser/crates/security/src/lib.rs`
- Modify: `/home/krolik/src/ox-browser/crates/security/Cargo.toml`
- Test: inline `#[cfg(test)]` in `fingerprint.rs`
- Create: `/home/krolik/src/ox-browser/crates/security/src/fingerprints.json`
...
Edit `/home/krolik/src/ox-browser/crates/security/Cargo.toml`:
```toml
[package]
name = "ox-security"
...
Create `/home/krolik/src/ox-browser/crates/security/src/fingerprints.json`. This is a subset of Wappalyzer format covering the most common technologies:
...
**Files:**
- Create: `/home/krolik/src/ox-browser/crates/js/src/analyze.rs`
- Modify: `/home/krolik/src/ox-browser/crates/js/src/lib.rs`
- Modify: `/home/krolik/src/ox-browser/crates/js/Cargo.toml`
...
Edit `/home/krolik/src/ox-browser/crates/js/Cargo.toml` — add to `[dependencies]`:
```toml
...
Edit `/home/krolik/src/ox-browser/crates/js/src/lib.rs` — add `mod analyze;` and the route:
...
```bash
cd /home/krolik/src/ox-browser && cargo test -p ox-js
```
...
**Files:**
- Create: `/home/krolik/src/go-code/internal/webanalyze/client.go`
- Create: `/home/krolik/src/go-code/internal/webanalyze/client_test.go`
...
```bash
cd /home/krolik/src/go-code && go test ./internal/webanalyze/ -v
```
...
**Files:**
- Create: `/home/krolik/src/go-code/internal/webanalyze/sourcemap.go`
- Create: `/home/krolik/src/go-code/internal/webanalyze/sourcemap_test.go`
...
```bash
cd /home/krolik/src/go-code && go test ./internal/webanalyze/ -run TestParse -v
```
...
**Files:**
- Create: `/home/krolik/src/go-code/cmd/go-code/tool_site_analyze.go`
...
```bash
cd /home/krolik/src/go-code && go build ./cmd/go-code/
