...
supersedes: deploy/krolik-server/plans/go-code/2026-06-02-find-duplicates-semantic-clone.md (option 3)
risk: M
phases: 4
---
...
- Needs `DATABASE_URL` + indexed go-code → integration test, build-tagged, runs on krolik
