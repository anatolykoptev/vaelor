...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -run TestParse -count=1 -v 2>&1 | tail -20`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -run TestExtractCalls -v -count=1`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -count=1`
Expected: All PASS.
...
Run: `cd /home/krolik/src/go-code && go test ./internal/callgraph/ -run TestBuildCallGraph -v -count=1`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/callgraph/ -run TestTrace -v -count=1`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/callgraph/ -run TestTraceRepo -v -count=1`
