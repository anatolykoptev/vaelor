...
**Files:**
- Create: `/home/krolik/src/go-code/internal/parser/relationships.go`
- Create: `/home/krolik/src/go-code/internal/parser/relationships_test.go`
- Create: `/home/krolik/src/go-code/internal/parser/queries/go_rels.scm`
- Modify: `/home/krolik/src/go-code/internal/parser/handler.go` (add interface + capture constants)
- Modify: `/home/krolik/src/go-code/internal/parser/handler_go.go` (implement RelationshipQueryProvider)

**Step 1: Add capture constants and RelationshipQueryProvider interface**

In `/home/krolik/src/go-code/internal/parser/handler.go`, add after the existing capture constants:
...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -run TestExtractRelationships -v`
...
In `/home/krolik/src/go-code/internal/parser/handler_go.go`:
...
sudo -u krolik git add internal/parser/relationships.go internal/parser/relationships_test.go internal/parser/queries/go_rels.scm internal/parser/handler.go internal/parser/handler_go.go
sudo -u krolik git commit -m "feat(parser): add TypeRelationship extraction for Go struct/interface embedding
...
**Files:**
- Create: `/home/krolik/src/go-code/internal/parser/queries/python_rels.scm`
- Create: `/home/krolik/src/go-code/internal/parser/queries/typescript_rels.scm`
- Create: `/home/krolik/src/go-code/internal/parser/queries/java_rels.scm`
- Modify: `/home/krolik/src/go-code/internal/parser/handler_python.go` (implement RelationshipQueryProvider)
- Modify: `/home/krolik/src/go-code/internal/parser/handler_typescript.go` (implement RelationshipQueryProvider)
- Modify: `/home/krolik/src/go-code/internal/parser/handler_java.go` (implement RelationshipQueryProvider)
- Modify: `/home/krolik/src/go-code/internal/parser/relationships_test.go` (add tests)

**Step 1: Write the failing tests**

Add to `/home/krolik/src/go-code/internal/parser/relationships_test.go`:
...
Run: `cd /home/krolik/src/go-code && go test ./internal/parser/ -run "TestExtractRelationships_(Python|TypeScript|Java)" -v`
...
In `/home/krolik/src/go-code/internal/parser/relationships.go`, update `runRelationshipQuery` to pass capture context to `inferRelKind`. For TypeScript and Java, the query file captures distinguish extends vs implements via different patterns that produce different match indices.
...
**Files:**
- Modify: `/home/krolik/src/go-code/internal/codegraph/parse.go` (extract relationships in parallel)
- Modify: `/home/krolik/src/go-code/internal/codegraph/graph_build.go` (build INHERITS/IMPLEMENTS edges)
- Modify: `/home/krolik/src/go-code/internal/codegraph/schema.go` (update schema text)
- Modify: `/home/krolik/src/go-code/internal/codegraph/index.go` (pass relationships through)

**Step 1: Update indexParseResult and ingestAndParse**

In `/home/krolik/src/go-code/internal/codegraph/parse.go`:
...
In `/home/krolik/src/go-code/internal/codegraph/graph_build.go`:
...
In `/home/krolik/src/go-code/internal/codegraph/schema.go`, add after the FETCHES line:
...
In `/home/krolik/src/go-code/internal/codegraph/index.go`, update the `ingestAndParse` call to receive `rels`:
...
```bash
cd /home/krolik/src/go-code
sudo -u krolik git add internal/codegraph/parse.go internal/codegraph/graph_build.go internal/codegraph/schema.go internal/codegraph/index.go
sudo -u krolik git commit -m "feat(codegraph): build INHERITS and IMPLEMENTS edges from type relationships
...
**Files:**
- Modify: `/home/krolik/src/go-code/internal/codegraph/templates.go`
- Modify: `/home/krolik/src/go-code/internal/codegraph/templates_test.go` (if exists, else create)

**Step 1: Write failing test**

Create or add to `/home/krolik/src/go-code/internal/codegraph/templates_test.go`:
...
Run: `cd /home/krolik/src/go-code && go test ./internal/codegraph/ -run "TestNewTemplatesExist|TestTemplateList" -v`
Expected: FAIL — templates not found

**Step 3: Add templates**

In `/home/krolik/src/go-code/internal/codegraph/templates.go`, add to the `templates` map:
...
```bash
cd /home/krolik/src/go-code
sudo -u krolik git add internal/codegraph/templates.go internal/codegraph/templates_test.go
sudo -u krolik git commit -m "feat(codegraph): add Cypher templates for type hierarchy queries
...
**Files:**
- Create: `/home/krolik/src/go-code/internal/compare/relstats.go`
- Create: `/home/krolik/src/go-code/internal/compare/relstats_test.go`
- Modify: `/home/krolik/src/go-code/internal/compare/compare.go` (add RelStats to CompareResult)
- Modify: `/home/krolik/src/go-code/internal/compare/snapshot.go` (extract relationships during snapshot)
- Modify: `/home/krolik/src/go-code/internal/compare/context.go` (include RelStats in LLM context)
...
In `/home/krolik/src/go-code/internal/compare/compare.go`, add to `CompareResult`:
...
In `/home/krolik/src/go-code/internal/compare/snapshot.go`, add `Rels` field to `RepoSnapshot`:
...
In `/home/krolik/src/go-code/internal/compare/context.go`, add a `writeRelStats` section in `BuildCompareContextV2` after the hotspots section:
...
```bash
cd /home/krolik/src/go-code
sudo -u krolik git add internal/compare/relstats.go internal/compare/relstats_test.go internal/compare/compare.go internal/compare/snapshot.go internal/compare/context.go
sudo -u krolik git commit -m "feat(compare): add type hierarchy stats to code comparison
