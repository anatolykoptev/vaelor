...
Run: `cd /home/krolik/src/go-code && go test ./internal/ingest/ -run "TestContentFilter|TestFilterFiles_ByMatchSet" -v`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/compare/ -run "TestBuildSnapshot_ContentFallback|TestBuildSnapshot_PathFocusNoFallback" -v`
...
```
code_compare repo_a=/home/krolik/src/go-kit repo_b=/home/krolik/src/go-engine focus="llm metrics retry" query="Compare llm, metrics, and retry packages"
```
...
```
code_compare repo_a=/home/krolik/src/go-kit repo_b=/home/krolik/src/go-engine focus="pkg/llm"
```
