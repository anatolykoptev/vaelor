...
**Files:**
- Create: `/path/to/repos/src/go-code/internal/codesearch/search.go`
- Create: `/path/to/repos/src/go-code/internal/codesearch/search_test.go`
- Create: `/path/to/repos/src/go-code/cmd/go-code/tool_code_search.go`
- Modify: `/path/to/repos/src/go-code/cmd/go-code/register.go` (add registration)
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/codesearch/ -v`
...
In `/path/to/repos/src/go-code/cmd/go-code/register.go`, find the registration block and add:
...
sudo -u example git add internal/codesearch/search.go internal/codesearch/search_test.go cmd/go-code/tool_code_search.go cmd/go-code/register.go
...
**Files:**
- Modify: `/path/to/repos/src/go-code/internal/codegraph/classify.go`
- Modify: `/path/to/repos/src/go-code/internal/prompts/prompts.go`
- Create: `/path/to/repos/src/go-code/internal/codegraph/classify_test.go` (add classification tests if doesn't exist, or extend)

**Step 1: Write failing test**

Add to or create `/path/to/repos/src/go-code/internal/codegraph/classify_test.go`:
...
In `/path/to/repos/src/go-code/internal/prompts/prompts.go`, update `SystemPromptClassifyGraphQuery`:
...
In `/path/to/repos/src/go-code/internal/codegraph/classify.go`, update the `Classify` function:
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/codegraph/ -run TestClassify -v -count=1`
Expected: PASS
...
```bash
cd /path/to/repos/src/go-code
sudo -u example git add internal/codegraph/classify.go internal/codegraph/classify_test.go internal/prompts/prompts.go
sudo -u example git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/path/to/repos/src/go-code/internal/deadcode/deadcode.go`
- Modify: `/path/to/repos/src/go-code/internal/deadcode/deadcode_test.go`

**Step 1: Write failing tests**

Add to `/path/to/repos/src/go-code/internal/deadcode/deadcode_test.go`:
...
In `/path/to/repos/src/go-code/internal/deadcode/deadcode.go`, add heuristic functions:
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/deadcode/ -v -count=1`
Expected: All PASS
...
```bash
cd /path/to/repos/src/go-code
sudo -u example git add internal/deadcode/deadcode.go internal/deadcode/deadcode_test.go
sudo -u example git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `/path/to/repos/src/go-code/internal/prompts/prompts.go`
- Modify: `/path/to/repos/src/go-code/internal/codegraph/generate_test.go` (add test)

**Step 1: Write failing test**

Add to `/path/to/repos/src/go-code/internal/codegraph/generate_test.go`:
...
In `/path/to/repos/src/go-code/internal/prompts/prompts.go`, update `SystemPromptGenerateCypher`:
...
Run: `cd /path/to/repos/src/go-code && go test ./internal/codegraph/ -run TestCypherSystemPrompt -v -count=1`
Expected: PASS
...
```bash
cd /path/to/repos/src/go-code
sudo -u example git add internal/prompts/prompts.go internal/codegraph/generate_test.go
sudo -u example git commit -m "$(cat <<'EOF'
...
```bash
cd /path/to/repos/src/go-code && go test ./internal/codesearch/ -v -count=1
cd /path/to/repos/src/go-code && go test ./internal/codegraph/ -v -count=1
cd /path/to/repos/src/go-code && go test ./internal/deadcode/ -v -count=1
