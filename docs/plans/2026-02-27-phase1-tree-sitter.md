...
**Current state:** Project scaffolded at `/home/krolik/src/go-code/` with stub implementations (all TODOs). go.mod has no dependencies yet, project does not compile.
...
**Files:**
- Modify: `/home/krolik/src/go-code/go.mod`
- Create: `/home/krolik/src/go-code/go.sum`
...
```bash
cd /home/krolik/src/go-code && CGO_ENABLED=1 go build ./cmd/go-code/
```
...
**Files:**
- Rewrite: `/home/krolik/src/go-code/internal/parser/parser.go`
- Modify: `/home/krolik/src/go-code/internal/parser/queries/go.scm` (verify/fix queries)
- Create: `/home/krolik/src/go-code/internal/parser/handler_go.go`
- Create: `/home/krolik/src/go-code/internal/parser/handler.go` (interface + registry)
- Create: `/home/krolik/src/go-code/internal/parser/parser_test.go`
- Create: `/home/krolik/src/go-code/internal/parser/testdata/sample.go`
...
```bash
cd /home/krolik/src/go-code && CGO_ENABLED=1 go test ./internal/parser/ -v
```
...
**Files:**
- Create: `/home/krolik/src/go-code/internal/parser/handler_python.go`
- Create: `/home/krolik/src/go-code/internal/parser/handler_typescript.go`
- Modify: `/home/krolik/src/go-code/internal/parser/queries/python.scm` (verify/fix)
- Modify: `/home/krolik/src/go-code/internal/parser/queries/typescript.scm` (verify/fix)
- Create: `/home/krolik/src/go-code/internal/parser/testdata/sample.py`
- Create: `/home/krolik/src/go-code/internal/parser/testdata/sample.ts`
- Modify: `/home/krolik/src/go-code/internal/parser/parser_test.go`
...
```bash
cd /home/krolik/src/go-code && CGO_ENABLED=1 go test ./internal/parser/ -v -count=1
```
...
**Files:**
- Rewrite: `/home/krolik/src/go-code/internal/ingest/ingest.go`
- Create: `/home/krolik/src/go-code/internal/ingest/ignore.go` (gitignore + defaults)
- Create: `/home/krolik/src/go-code/internal/ingest/tree.go` (file tree rendering)
- Create: `/home/krolik/src/go-code/internal/ingest/ingest_test.go`
- Create: `/home/krolik/src/go-code/internal/ingest/testdata/` (test fixtures)
...
```bash
cd /home/krolik/src/go-code && go test ./internal/ingest/ -v
```
...
**Files:**
- Rewrite: `/home/krolik/src/go-code/internal/clean/clean.go`
- Create: `/home/krolik/src/go-code/internal/clean/comments.go` (per-language comment stripping)
- Create: `/home/krolik/src/go-code/internal/clean/clean_test.go`
...
**Files:**
- Rewrite: `/home/krolik/src/go-code/internal/analyze/analyze.go`
- Create: `/home/krolik/src/go-code/internal/analyze/context.go` (LLM context builder)
- Create: `/home/krolik/src/go-code/internal/analyze/analyze_test.go`
...
**Files:**
- Rewrite: `/home/krolik/src/go-code/cmd/go-code/tool_repo_analyze.go`
- Rewrite: `/home/krolik/src/go-code/cmd/go-code/tool_file_parse.go`
- Modify: `/home/krolik/src/go-code/cmd/go-code/register.go`
- Modify: `/home/krolik/src/go-code/cmd/go-code/main.go` (init workspace dir)
...
```bash
cd /home/krolik/src/go-code && CGO_ENABLED=1 go build -o bin/go-code ./cmd/go-code
...
```bash
cd /home/krolik/src/go-code && CGO_ENABLED=1 make test
```

**Step 3: Build Docker image**

```bash
cd /home/krolik/src/go-code && docker build -t go-code:test .
```

**Step 4: Add to docker-compose**

Add `go-code` service to `/home/krolik/deploy/krolik-server/docker-compose.yml`.
