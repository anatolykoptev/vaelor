...
<response tool="debug_investigate">
  <investigation service="go-code" started_at="..." finished_at="...">
    ...
    ...
    <metric_spikes>
      <spike metric="signaling_call_outcome_total" labels="{service=&quot;acme-web&quot;}" ratio="4.70" score="0.800"/>
      <spike metric="ws_handshake_failed_total"    labels="{service=&quot;acme-web&quot;}" ratio="2.10" score="0.600"/>
    </metric_spikes>
