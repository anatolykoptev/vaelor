...
Run: `cd /home/krolik/src/go-code && grep sourcegraph/scip go.mod`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/scip/ -v -run TestReadIndex`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/scip/ -v -run TestConvertToEdges`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/scip/ -v`
Expected: All PASS
...
Run: `cd /home/krolik/src/go-code && go test ./internal/scip/ -v -run TestDetectIndexer`
Expected: FAIL
...
Run: `cd /home/krolik/src/go-code && go test ./internal/scip/ -v -run TestRunIndexer`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/callgraph/ -v -run TestBuildFromRepo_SCIP -timeout 120s`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/callgraph/ -v -timeout 120s`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/tier/ -v -run TestDetectSCIP`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/tier/ -v`
Expected: All PASS
...
Run: `cd /home/krolik/src/go-code && docker build -t go-code-scip-test .`
...
Run: `cd /home/krolik/src/go-code && go test ./internal/scip/ -v -run TestE2E -timeout 120s`
Expected: Tests PASS for installed indexers, SKIP for missing ones.

- [ ] **Step 3: Run full repo test suite**

Run: `cd /home/krolik/src/go-code && go test ./... -timeout 300s`
