...
func GenerateCypher(ctx context.Context, client llm.Completer, query string) (string, error) {
...
func GenerateCypherWithRetry(ctx context.Context, client llm.Completer, query, firstErr string) (string, error) {
	hint := ""
