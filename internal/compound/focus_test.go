...
func TestFilterByFocus(t *testing.T) {
	sym1 := &parser.Symbol{Name: "toggle", Kind: parser.KindFunction, File: "/host/src/acme-guide/frontend/src/components/ThemeToggle.svelte", StartLine: 8}
	sym2 := &parser.Symbol{Name: "toggle", Kind: parser.KindFunction, File: "/host/src/acme-guide/frontend/src/components/Filters.svelte", StartLine: 3}
