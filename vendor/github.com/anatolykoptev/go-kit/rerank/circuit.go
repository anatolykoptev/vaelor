...
// ErrCircuitOpen is returned by callCohereResilient when the circuit breaker
// is in the Open state and has blocked the call.
var ErrCircuitOpen = errors.New("rerank: circuit breaker open")
...
func NewCircuitBreaker(cfg CircuitConfig, onTransition func(CircuitState, CircuitState)) *CircuitBreaker {
