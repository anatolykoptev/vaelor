...
- **15 languages** — Go, Python, TypeScript/JavaScript, Rust, Java, C, C++, Ruby, C#, PHP, Svelte, Astro, Kotlin, Swift
...
| `rewrite` | Structural AST search-replace with $WILDCARDS across 15 languages, dry-run + apply |
...
internal/
  parser/             — tree-sitter AST parsing, 15 language handlers
